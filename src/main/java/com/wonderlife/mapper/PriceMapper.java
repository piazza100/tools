...
@Mapper public interface PriceMapper{
 ...
 @Insert("INSERT INTO tools_price_raw_responses(collection_run_id,page_no,response_json) VALUES(#{runId},#{pageNo},CAST(#{json} AS JSON))") void insertRaw(@Param("runId")long runId,@Param("pageNo")int pageNo,@Param("json")String json);

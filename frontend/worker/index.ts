...
const INDEXABLE_PATHS = [
  '/', '/guides', '/links', '/about', '/privacy', '/terms', '/contact', '/methodology', '/data/minimum-wage', '/data/salary-take-home', '/data/korean-holidays', '/data/basket-price-index', '/data/retail-price-history', '/data/regional-prices',
